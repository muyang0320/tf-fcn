...
class FCN8VGG:
    def __init__(self, vgg16_npy_path=None):
        # vgg16_npy_path == None 没指定路径当然默认当前路径下 且为None
        if vgg16_npy_path is None:
            # self.__class__ == __main__.FCN8VGG
            # self.__class__.__module__ == __main__
            path = sys.modules[self.__class__.__module__].__file__ # /Users/hydra320/Master/tensorflow/fcn/tensorflow-fcn/fcn8_vgg.py
            path = os.path.abspath(os.path.join(path, os.pardir)) # /Users/hydra320/Master/tensorflow/fcn/tensorflow-fcn
            path = os.path.join(path, "vgg16.npy") # /Users/hydra320/Master/tensorflow/fcn/tensorflow-fcn/vgg16.npy
            return
            vgg16_npy_path = path
            # 弄那么久就是为了拿到当前目录下的vgg16.npy
    ...
    def build(self, rgb, train=False, num_classes=20, random_init_fc8=False,
        ...
        with tf.name_scope('Processing'):
            ...
            red, green, blue = tf.split(rgb, 3, 3) # 2参是slipt成的个数 3参是axis 对于tensor而言是channel
